  ...
  <div class="Div">
    <div class="eyeList">
      <div class="logoDiv">
        <div class="logoP">
          <div class="logo">
            <img id="logo1" src="/static/views/eye8/svg/logo-1.svg" alt="SVG Image" width='auto' height='230px'
                 draggable="false">
            <img id="logo2" src="/static/views/eye8/svg/logo-2.svg" alt="SVG Image" width='auto' height='90px'
                 draggable="false">
          </div>
        </div>
        <div class="textDiv">
