<template>
  <div class="Div">
    <div class="notFound">
      <picture>
        <source class="avif" srcset="/static/views/error-views/not-found/avif/not-found-p.avif" type="image/avif">
        <img src="/static/views/error-views/not-found/svg/not-found.svg" alt="SVG Image" draggable="false">
      </picture>
