<template>
  <div class="Div" :style="mainDevStyle">
    <div class="home" ref="mainDiv" :style="homeStyle">
      <div class="logo">
        <img class='ring' src="/static/views/home-view/svg/ring.svg" fetchpriority=high width='auto' height='170px' draggable="false">
        <img class='logo_image' src="/static/brand/ccwiki-logo-0.svg" fetchpriority=high width='auto' height='120px'
             draggable="false">
      </div>
      <div class='newsList'>
        <div class="newsDiv" style="margin-left: 0;">
          <img class='image' src="/static/views/home-view/svg/not-found-bg.svg" alt='' draggable="false">
      ...
      <div class="updateList">
        <div class="updateDiv" style="margin-top: 0;">
          <div class="imgDiv">
            <div class="ring">
              <img class='ring2' src="/static/views/home-view/svg/ring-2.svg" alt='' draggable="false">
            </div>
          </div>
          <div class="textDiv">
