    ...
    <div class="Div">
        <div class="eyeList">
            <div class="logoDiv">
                <div class="logoP">
                    <div class="logo">
                        <img id="logo1" src="/static/eye8/svg/logo1.svg" alt="SVG Image" width='auto' height='230px' draggable="false">
                        <img id="logo2" src="/static/eye8/svg/logo2.svg" alt="SVG Image" width='auto' height='90px' draggable="false">
                    </div>
                </div>
                <div class="textDiv">
                    <div class="card">
                ...
                <div class="main">
                    <div class="listW">
                        <div class="option" :style="{ 'margin-right': OmarginRight }">
                            ...
                            <ApexCharts class="charts" type="area" height="140" :options="chartOptions" :series="series" :xaxis="xaxis"></ApexCharts>
                        </div>
...
.Div .eyeList .logoDiv .textDiv .textList h2 {
    font-size: 26px;
    font-weight: 500;
    letter-spacing: .5px;
    margin: 0 0 2px;
...
.Div .eyeList .logoDiv .logoP {
    width: 100%;
    user-select: none;
    text-align: center;
}

.Div .eyeList .logoDiv .logoP .logo {
    display: grid;
    user-select: none;
    position: relative;
}

.Div .eyeList .logoDiv .logoP .logo #logo2 {
    grid-area: 1;
    position: absolute;
    /* animation: 1s linear 0s infinite normal none running init_loading2; */
    animation: Eye8_logoA1 10s infinite;
    /* animation: init_loading2 3s infinite; */
    margin-top: 70px;
    margin-left: 70px;
}

.Div .eyeList .mainDiv .main .listW {
    display: flex;
    flex-direction: row;
    margin-top: 30px;
}

.Div .eyeList .mainDiv .main .listW .option {
    width: 300px;
    height: 200px;
    border-radius: 15px;
...
.Div .eyeList .mainDiv .main .listW .option .titleDiv {
    width: 100%;
    height: 60px;
    padding: 10px;
}
...
.Div .eyeList .mainDiv .main .listW .option .charts {}
</style>